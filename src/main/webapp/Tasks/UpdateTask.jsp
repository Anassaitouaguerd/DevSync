...
<div class="container">
    ...
    <form action="update" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="taskName" name="title" value="${task.title}" required>
        </div>
        <div class="form-group">
        ...
        <c:if test="${not empty sessionScope.user.manager}">
            <c:if test="${sessionScope.user.manager eq 'true'}">
                <div class="form-group">
                    ...
                    <select id="assignedTo" name="assignedToUP" required>
                            ...
                            <c:forEach items="${tagsList}" var="tag">
                                <label>
                                    <input type="checkbox" name="Tag" value="${tag.id}"
                                        ${task.tags.contains(tag) ? 'checked' : ''}> ${tag.name}
                                </label>
                            </c:forEach>
                        </c:when>
                        <c:otherwise>
